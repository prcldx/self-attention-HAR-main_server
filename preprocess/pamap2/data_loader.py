...
def get_pamap2_data(verbose=False):
    ...
    read_dataset(train_test_files=train_test_files,
                 ...
                 output_file_name=os.path.join(data_config['data_dir']['processed'], config['output_file']))#output_file_name=os.path.join(data_config['data_dir']['processed'], config['output_file'])
